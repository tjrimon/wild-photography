        ...
        <div className=' bg-gray-200'>
            <div className='grid grid-cols-1 md:grid-cols-2 py-20 md:py-32 container justify-center mx-auto items-center'>
                <div className='mx-auto md:text-left text-center order-2 mt-12 md:mt-0 md:order-none'>
                    ...
                    <p className='w-[300px] py-3 text-lg'>Hello everyone, I'm a front-end developer. My goal is to get a intern or job under a good team where I can learn properly. In future I'll learn PHP, Laravl, Wordpress.</p>
